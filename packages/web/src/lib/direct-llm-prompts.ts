/**
 * Prompt templates and domain-specific supplements for direct LLM mode.
 * Extracted from direct-llm.ts for code health (was 1,244 lines).
 * 
 * CROSS_MODULE_INVARIANTS: These prompts are synced with:
 * - BE: apps/api/engines/dialogue/prompts/feynman_system.py
 * - Workers: workers/src/prompts.ts
 * See CROSS_MODULE_INVARIANTS.md for sync rules.
 */
...
export const ASSESSMENT_SUPPLEMENTS: Record<string, string> = {
...
export const DOMAIN_SUPPLEMENTS: Record<string, string> = {
