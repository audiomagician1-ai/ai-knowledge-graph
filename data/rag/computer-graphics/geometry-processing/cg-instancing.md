...
Hardware Instancing与Indirect Instancing

## 关键要点

### 数学基础
- 理解实例化渲染背后的数学原理（线性代数/微积分/概率论等）
- 掌握从数学公式到GPU实现的转化思路
- 了解数值精度和性能之间的权衡
...
- 使用ShaderToy或RenderDoc等工具动手实验实例化渲染效果
- 阅读GPU Gems/Real-Time Rendering等经典参考资料
- 在游戏引擎中观察和修改实例化渲染的实际实现
