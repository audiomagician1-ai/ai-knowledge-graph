...
待机动画是关键帧动画领域的基础知识点。角色静止时的微动——呼吸/重心移动/环顾。

### 关键要点

- **定义**: 待机动画——角色静止时的微动——呼吸/重心移动/环顾
- **重要性**: 在游戏动画制作中，待机动画是确保动画质量和效率的关键环节
- **应用场景**: 待机动画广泛应用于游戏角色动画、过场动画和交互动画制作中

### 详细说明

待机动画涉及多个方面的专业知识。在实际游戏项目中，动画师需要理解待机动画的原理，并能够在DCC工具（如Maya、Blender）和游戏引擎（如UE5、Unity）中熟练运用。
