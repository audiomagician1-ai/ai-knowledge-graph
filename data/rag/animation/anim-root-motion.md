...
Root Motion——动画驱动角色位移 vs 代码驱动位移。

## 核心知识

### 基本概念

根运动是关键帧动画领域的基础知识点。Root Motion——动画驱动角色位移 vs 代码驱动位移。

### 关键要点

- **定义**: 根运动——Root Motion——动画驱动角色位移 vs 代码驱动位移
- **重要性**: 在游戏动画制作中，根运动是确保动画质量和效率的关键环节
- **应用场景**: 根运动广泛应用于游戏角色动画、过场动画和交互动画制作中

### 详细说明

根运动涉及多个方面的专业知识。在实际游戏项目中，动画师需要理解根运动的原理，并能够在DCC工具（如Maya、Blender）和游戏引擎（如UE5、Unity）中熟练运用。
