...
动画导出是关键帧动画领域的基础知识点。FBX/glTF导出设置——帧率/采样/骨骼/单位。

### 关键要点

- **定义**: 动画导出——FBX/glTF导出设置——帧率/采样/骨骼/单位
- **重要性**: 在游戏动画制作中，动画导出是确保动画质量和效率的关键环节
- **应用场景**: 动画导出广泛应用于游戏角色动画、过场动画和交互动画制作中

### 详细说明

动画导出涉及多个方面的专业知识。在实际游戏项目中，动画师需要理解动画导出的原理，并能够在DCC工具（如Maya、Blender）和游戏引擎（如UE5、Unity）中熟练运用。
