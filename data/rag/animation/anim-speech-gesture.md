...
对话时的身体语言——手势/点头/倾斜的配合。

## 核心知识

### 基本概念

说话手势是面部动画领域的基础知识点。对话时的身体语言——手势/点头/倾斜的配合。

### 关键要点

- **定义**: 说话手势——对话时的身体语言——手势/点头/倾斜的配合
- **重要性**: 在游戏动画制作中，说话手势是确保动画质量和效率的关键环节
- **应用场景**: 说话手势广泛应用于游戏角色动画、过场动画和交互动画制作中

### 详细说明

说话手势涉及多个方面的专业知识。在实际游戏项目中，动画师需要理解说话手势的原理，并能够在DCC工具（如Maya、Blender）和游戏引擎（如UE5、Unity）中熟练运用。
