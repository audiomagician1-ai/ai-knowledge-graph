...
多角色共用同一AnimBP/动画资产的设计。

## 核心知识

### 基本概念

动画共享是动画蓝图领域的基础知识点。多角色共用同一AnimBP/动画资产的设计。

### 关键要点

- **定义**: 动画共享——多角色共用同一AnimBP/动画资产的设计
- **重要性**: 在游戏动画制作中，动画共享是确保动画质量和效率的关键环节
- **应用场景**: 动画共享广泛应用于游戏角色动画、过场动画和交互动画制作中

### 详细说明

动画共享涉及多个方面的专业知识。在实际游戏项目中，动画师需要理解动画共享的原理，并能够在DCC工具（如Maya、Blender）和游戏引擎（如UE5、Unity）中熟练运用。
