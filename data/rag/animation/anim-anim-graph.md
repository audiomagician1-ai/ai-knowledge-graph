...
AnimGraph——连接状态机/混合/IK等节点的可视化图。

## 核心知识

### 基本概念

动画图是动画蓝图领域的基础知识点。AnimGraph——连接状态机/混合/IK等节点的可视化图。

### 关键要点

- **定义**: 动画图——AnimGraph——连接状态机/混合/IK等节点的可视化图
- **重要性**: 在游戏动画制作中，动画图是确保动画质量和效率的关键环节
- **应用场景**: 动画图广泛应用于游戏角色动画、过场动画和交互动画制作中

### 详细说明

动画图涉及多个方面的专业知识。在实际游戏项目中，动画师需要理解动画图的原理，并能够在DCC工具（如Maya、Blender）和游戏引擎（如UE5、Unity）中熟练运用。
