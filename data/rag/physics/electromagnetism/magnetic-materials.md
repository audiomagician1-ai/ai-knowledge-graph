...
磁性材料是电磁学领域中的概念，难度等级为 5/9。

顺磁、抗磁、铁磁、磁化强度、磁滞

## 核心内容

在电磁学中，磁性材料属于Maxwell方程组的框架。电场 $\vec{E}$ 和磁场 $\vec{B}$ 通过 $\nabla \times \vec{E} = -\frac{\partial \vec{B}}{\partial t}$ 关联。

### 关键要点

1. **基本定义**: 顺磁、抗磁、铁磁、磁化强度、磁滞
2. **物理意义**: 磁性材料在物理学体系中具有重要地位
...
磁性材料在物理知识体系中与多个概念相互关联，建议结合相关前置知识一起学习。
