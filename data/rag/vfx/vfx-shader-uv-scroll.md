...
UV滚动是Shader特效领域的基础知识点。UV偏移/旋转实现流动、旋转等持续动画

### 关键要点

- **定义**: UV滚动——UV偏移/旋转实现流动、旋转等持续动画
- **难度级别**: 基础（难度2/5）
- **应用场景**: UV滚动在游戏特效制作中是入门必备知识
- **引擎支持**: HLSL/GLSL/Shader Graph/Material Editor

### 详细说明

UV滚动涉及多个方面的专业知识。在实际游戏项目中，特效师需要理解UV滚动的原理，并能在UE Material Editor、Unity Shader Graph、RenderDoc中熟练运用。
