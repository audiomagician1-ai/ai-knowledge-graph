...
SSAO/HBAO/GTAO等屏幕空间AO技术

## 核心知识

### 基本概念

环境光遮蔽是后处理特效领域的核心技术。SSAO/HBAO/GTAO等屏幕空间AO技术

### 关键要点

- **定义**: 环境光遮蔽——SSAO/HBAO/GTAO等屏幕空间AO技术
- **难度级别**: 进阶（难度3/5）
- **应用场景**: 环境光遮蔽在游戏特效制作中需要一定基础才能掌握
- **引擎支持**: UE5/Unity通用后处理管线

### 详细说明

环境光遮蔽涉及多个方面的专业知识。在实际游戏项目中，特效师需要理解环境光遮蔽的原理，并能在Post Process Volume、Custom Render Pass、Render Target中熟练运用。
