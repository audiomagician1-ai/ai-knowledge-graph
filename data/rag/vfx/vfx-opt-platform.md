...
平台差异是特效优化领域的核心技术。PC/Console/Mobile不同平台的特效适配策略

### 关键要点

- **定义**: 平台差异——PC/Console/Mobile不同平台的特效适配策略
- **难度级别**: 进阶（难度3/5）
- **应用场景**: 平台差异在游戏特效制作中需要一定基础才能掌握
- **引擎支持**: UE5/Unity通用

### 详细说明

平台差异涉及多个方面的专业知识。在实际游戏项目中，特效师需要理解平台差异的原理，并能在Stat GPU、RenderDoc、PIX、Frame Debugger、Profiler中熟练运用。
