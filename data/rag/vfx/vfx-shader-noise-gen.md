...
concept_id: vfx-shader-noise-gen
difficulty: 3
...
Shader内生成Perlin/Voronoi/Worley噪声的技巧

## 核心知识

### 基本概念

噪声生成是Shader特效领域的核心技术。Shader内生成Perlin/Voronoi/Worley噪声的技巧

### 关键要点

- **定义**: 噪声生成——Shader内生成Perlin/Voronoi/Worley噪声的技巧
- **难度级别**: 进阶（难度3/5）
- **应用场景**: 噪声生成在游戏特效制作中需要一定基础才能掌握
- **引擎支持**: HLSL/GLSL/Shader Graph/Material Editor

### 详细说明

噪声生成涉及多个方面的专业知识。在实际游戏项目中，特效师需要理解噪声生成的原理，并能在UE Material Editor、Unity Shader Graph、RenderDoc中熟练运用。
