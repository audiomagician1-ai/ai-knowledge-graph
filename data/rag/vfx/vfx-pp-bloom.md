...
高亮区域光溢出效果的实现——阈值、模糊核与叠加

## 核心知识

### 基本概念

Bloom泛光是后处理特效领域的基础知识点。高亮区域光溢出效果的实现——阈值、模糊核与叠加

### 关键要点

- **定义**: Bloom泛光——高亮区域光溢出效果的实现——阈值、模糊核与叠加
- **难度级别**: 基础（难度2/5）
- **应用场景**: Bloom泛光在游戏特效制作中是入门必备知识
- **引擎支持**: UE5/Unity通用后处理管线

### 详细说明

Bloom泛光涉及多个方面的专业知识。在实际游戏项目中，特效师需要理解Bloom泛光的原理，并能在Post Process Volume、Custom Render Pass、Render Target中熟练运用。

#### 技术细节

掌握Bloom泛光需要以下步骤：

1. 理解Bloom泛光的基本原理和工作方式
2. 在引擎编辑器中进行实践练习
