...
纹理流动是Shader特效领域的基础知识点。多层纹理Panning混合实现岩浆、水流效果

### 关键要点

- **定义**: 纹理流动——多层纹理Panning混合实现岩浆、水流效果
- **难度级别**: 基础（难度2/5）
- **应用场景**: 纹理流动在游戏特效制作中是入门必备知识
- **引擎支持**: HLSL/GLSL/Shader Graph/Material Editor

### 详细说明

纹理流动涉及多个方面的专业知识。在实际游戏项目中，特效师需要理解纹理流动的原理，并能在UE Material Editor、Unity Shader Graph、RenderDoc中熟练运用。
