...
图集共享是特效优化领域的基础知识点。多特效共享纹理图集减少采样器与内存占用

### 关键要点

- **定义**: 图集共享——多特效共享纹理图集减少采样器与内存占用
- **难度级别**: 基础（难度2/5）
- **应用场景**: 图集共享在游戏特效制作中是入门必备知识
- **引擎支持**: UE5/Unity通用

### 详细说明

图集共享涉及多个方面的专业知识。在实际游戏项目中，特效师需要理解图集共享的原理，并能在Stat GPU、RenderDoc、PIX、Frame Debugger、Profiler中熟练运用。
