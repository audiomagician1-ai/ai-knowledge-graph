...
烟雾模拟是流体模拟领域的核心技术。烟雾体积模拟——密度场、浮力、耗散与渲染

### 关键要点

- **定义**: 烟雾模拟——烟雾体积模拟——密度场、浮力、耗散与渲染
- **难度级别**: 进阶（难度3/5）
- **应用场景**: 烟雾模拟在游戏特效制作中需要一定基础才能掌握
- **引擎支持**: Houdini + UE5/Unity

### 详细说明

烟雾模拟涉及多个方面的专业知识。在实际游戏项目中，特效师需要理解烟雾模拟的原理，并能在Houdini FLIP/Pyro、Niagara Fluid、Compute Shader中熟练运用。
