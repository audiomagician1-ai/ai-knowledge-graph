...
FFT海洋、Gerstner波等大规模水面模拟

## 核心知识

### 基本概念

海洋模拟是流体模拟领域的核心技术。FFT海洋、Gerstner波等大规模水面模拟

### 关键要点

- **定义**: 海洋模拟——FFT海洋、Gerstner波等大规模水面模拟
- **难度级别**: 高级（难度4/5）
- **应用场景**: 海洋模拟在游戏特效制作中需要一定基础才能掌握
- **引擎支持**: Houdini + UE5/Unity

### 详细说明

海洋模拟涉及多个方面的专业知识。在实际游戏项目中，特效师需要理解海洋模拟的原理，并能在Houdini FLIP/Pyro、Niagara Fluid、Compute Shader中熟练运用。
