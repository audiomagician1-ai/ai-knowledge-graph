...
基于流体的火焰模拟——温度场、燃烧模型与渲染

## 核心知识

### 基本概念

火焰模拟是流体模拟领域的核心技术。基于流体的火焰模拟——温度场、燃烧模型与渲染

### 关键要点

- **定义**: 火焰模拟——基于流体的火焰模拟——温度场、燃烧模型与渲染
- **难度级别**: 进阶（难度3/5）
- **应用场景**: 火焰模拟在游戏特效制作中需要一定基础才能掌握
- **引擎支持**: Houdini + UE5/Unity

### 详细说明

火焰模拟涉及多个方面的专业知识。在实际游戏项目中，特效师需要理解火焰模拟的原理，并能在Houdini FLIP/Pyro、Niagara Fluid、Compute Shader中熟练运用。
