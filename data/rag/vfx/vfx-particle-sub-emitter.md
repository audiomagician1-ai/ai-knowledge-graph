...
子发射器是粒子物理领域的核心技术。粒子生成/碰撞/消亡时触发子粒子系统

### 关键要点

- **定义**: 子发射器——粒子生成/碰撞/消亡时触发子粒子系统
- **难度级别**: 进阶（难度3/5）
- **应用场景**: 子发射器在游戏特效制作中需要一定基础才能掌握
- **引擎支持**: 通用引擎(UE5/Unity/自研)

### 详细说明

子发射器涉及多个方面的专业知识。在实际游戏项目中，特效师需要理解子发射器的原理，并能在粒子编辑器、物理调试工具、曲线编辑器中熟练运用。
