...
concept_id: vfx-shader-vertex-anim
difficulty: 3
...
顶点动画是Shader特效领域的核心技术。Vertex Shader驱动的旗帜飘扬、水面波动

### 关键要点

- **定义**: 顶点动画——Vertex Shader驱动的旗帜飘扬、水面波动
- **难度级别**: 进阶（难度3/5）
- **应用场景**: 顶点动画在游戏特效制作中需要一定基础才能掌握
- **引擎支持**: HLSL/GLSL/Shader Graph/Material Editor

### 详细说明

顶点动画涉及多个方面的专业知识。在实际游戏项目中，特效师需要理解顶点动画的原理，并能在UE Material Editor、Unity Shader Graph、RenderDoc中熟练运用。
