...
concept_id: vfx-shader-blend-mode
difficulty: 2
content_type: theory
tags: [基础]
...
混合模式是Shader特效领域的基础知识点。Additive/Alpha/Pre-multiplied等混合模式原理与选择

### 关键要点

- **定义**: 混合模式——Additive/Alpha/Pre-multiplied等混合模式原理与选择
- **难度级别**: 基础（难度2/5）
- **应用场景**: 混合模式在游戏特效制作中是入门必备知识
- **引擎支持**: HLSL/GLSL/Shader Graph/Material Editor

### 详细说明

混合模式涉及多个方面的专业知识。在实际游戏项目中，特效师需要理解混合模式的原理，并能在UE Material Editor、Unity Shader Graph、RenderDoc中熟练运用。
