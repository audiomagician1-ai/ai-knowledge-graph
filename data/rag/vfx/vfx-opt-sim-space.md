...
Local vs World空间模拟对性能和效果的影响

## 核心知识

### 基本概念

模拟空间是特效优化领域的基础知识点。Local vs World空间模拟对性能和效果的影响

### 关键要点

- **定义**: 模拟空间——Local vs World空间模拟对性能和效果的影响
- **难度级别**: 基础（难度2/5）
- **应用场景**: 模拟空间在游戏特效制作中是入门必备知识
- **引擎支持**: UE5/Unity通用

### 详细说明

模拟空间涉及多个方面的专业知识。在实际游戏项目中，特效师需要理解模拟空间的原理，并能在Stat GPU、RenderDoc、PIX、Frame Debugger、Profiler中熟练运用。
