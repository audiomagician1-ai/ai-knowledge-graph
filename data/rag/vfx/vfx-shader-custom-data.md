...
concept_id: vfx-shader-custom-data
difficulty: 3
...
自定义数据是Shader特效领域的核心技术。粒子系统传递Custom Data到Shader的管线

### 关键要点

- **定义**: 自定义数据——粒子系统传递Custom Data到Shader的管线
- **难度级别**: 进阶（难度3/5）
- **应用场景**: 自定义数据在游戏特效制作中需要一定基础才能掌握
- **引擎支持**: HLSL/GLSL/Shader Graph/Material Editor

### 详细说明

自定义数据涉及多个方面的专业知识。在实际游戏项目中，特效师需要理解自定义数据的原理，并能在UE Material Editor、Unity Shader Graph、RenderDoc中熟练运用。
