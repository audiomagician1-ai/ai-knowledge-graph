...
concept_id: vfx-opt-collision-cost
difficulty: 3
...
碰撞开销是特效优化领域的核心技术。粒子碰撞检测的性能成本与简化策略

### 关键要点

- **定义**: 碰撞开销——粒子碰撞检测的性能成本与简化策略
- **难度级别**: 进阶（难度3/5）
- **应用场景**: 碰撞开销在游戏特效制作中需要一定基础才能掌握
- **引擎支持**: UE5/Unity通用

### 详细说明

碰撞开销涉及多个方面的专业知识。在实际游戏项目中，特效师需要理解碰撞开销的原理，并能在Stat GPU、RenderDoc、PIX、Frame Debugger、Profiler中熟练运用。
