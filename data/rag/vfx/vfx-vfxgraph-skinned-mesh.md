...
domain: vfx
subdomain: vfx-graph
concept_id: vfx-vfxgraph-skinned-mesh
difficulty: 3
...
从Skinned Mesh表面生成粒子的技术

## 核心知识

### 基本概念

蒙皮网格采样是VFX Graph领域的核心技术。从Skinned Mesh表面生成粒子的技术

### 关键要点

- **定义**: 蒙皮网格采样——从Skinned Mesh表面生成粒子的技术
- **难度级别**: 进阶（难度3/5）
- **应用场景**: 蒙皮网格采样在游戏特效制作中需要一定基础才能掌握
- **引擎支持**: Unity

### 详细说明

蒙皮网格采样涉及多个方面的专业知识。在实际游戏项目中，特效师需要理解蒙皮网格采样的原理，并能在VFX Graph Editor、Shader Graph、Timeline中熟练运用。

#### 技术细节

掌握蒙皮网格采样需要以下步骤：

1. 理解蒙皮网格采样的基本原理和工作方式
2. 在引擎编辑器中进行实践练习
