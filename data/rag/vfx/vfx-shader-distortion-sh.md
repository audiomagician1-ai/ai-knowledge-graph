...
concept_id: vfx-shader-distortion-sh
difficulty: 3
...
折射扭曲是Shader特效领域的核心技术。GrabPass/Scene Color采样实现折射与扭曲效果

### 关键要点

- **定义**: 折射扭曲——GrabPass/Scene Color采样实现折射与扭曲效果
- **难度级别**: 进阶（难度3/5）
- **应用场景**: 折射扭曲在游戏特效制作中需要一定基础才能掌握
- **引擎支持**: HLSL/GLSL/Shader Graph/Material Editor

### 详细说明

折射扭曲涉及多个方面的专业知识。在实际游戏项目中，特效师需要理解折射扭曲的原理，并能在UE Material Editor、Unity Shader Graph、RenderDoc中熟练运用。
