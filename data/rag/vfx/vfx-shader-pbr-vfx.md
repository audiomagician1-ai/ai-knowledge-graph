...
PBR工作流在特效材质(折射/透射/半透明)中的应用

## 核心知识

### 基本概念

PBR特效材质是Shader特效领域的核心技术。PBR工作流在特效材质(折射/透射/半透明)中的应用

### 关键要点

- **定义**: PBR特效材质——PBR工作流在特效材质(折射/透射/半透明)中的应用
- **难度级别**: 高级（难度4/5）
- **应用场景**: PBR特效材质在游戏特效制作中需要一定基础才能掌握
- **引擎支持**: HLSL/GLSL/Shader Graph/Material Editor

### 详细说明

PBR特效材质涉及多个方面的专业知识。在实际游戏项目中，特效师需要理解PBR特效材质的原理，并能在UE Material Editor、Unity Shader Graph、RenderDoc中熟练运用。

#### 技术细节

掌握PBR特效材质需要以下步骤：

1. 理解PBR特效材质的基本原理和工作方式
2. 在引擎编辑器中进行实践练习
