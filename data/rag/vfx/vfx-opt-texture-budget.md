...
concept_id: vfx-opt-texture-budget
difficulty: 2
content_type: theory
tags: [基础]
...
纹理预算是特效优化领域的基础知识点。特效纹理的分辨率、格式、压缩与共享策略

### 关键要点

- **定义**: 纹理预算——特效纹理的分辨率、格式、压缩与共享策略
- **难度级别**: 基础（难度2/5）
- **应用场景**: 纹理预算在游戏特效制作中是入门必备知识
- **引擎支持**: UE5/Unity通用

### 详细说明

纹理预算涉及多个方面的专业知识。在实际游戏项目中，特效师需要理解纹理预算的原理，并能在Stat GPU、RenderDoc、PIX、Frame Debugger、Profiler中熟练运用。
