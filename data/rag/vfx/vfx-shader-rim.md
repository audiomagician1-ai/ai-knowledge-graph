...
边缘光是Shader特效领域的基础知识点。Rim Light Shader实现角色受击、选中等高光边缘

### 关键要点

- **定义**: 边缘光——Rim Light Shader实现角色受击、选中等高光边缘
- **难度级别**: 基础（难度2/5）
- **应用场景**: 边缘光在游戏特效制作中是入门必备知识
- **引擎支持**: HLSL/GLSL/Shader Graph/Material Editor

### 详细说明

边缘光涉及多个方面的专业知识。在实际游戏项目中，特效师需要理解边缘光的原理，并能在UE Material Editor、Unity Shader Graph、RenderDoc中熟练运用。
