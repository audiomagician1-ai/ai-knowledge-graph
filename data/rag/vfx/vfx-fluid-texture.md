...
Flowmap、法线扰动等基于纹理的流体表现技巧

## 核心知识

### 基本概念

流体纹理是流体模拟领域的基础知识点。Flowmap、法线扰动等基于纹理的流体表现技巧

### 关键要点

- **定义**: 流体纹理——Flowmap、法线扰动等基于纹理的流体表现技巧
- **难度级别**: 基础（难度2/5）
- **应用场景**: 流体纹理在游戏特效制作中是入门必备知识
- **引擎支持**: Houdini + UE5/Unity

### 详细说明

流体纹理涉及多个方面的专业知识。在实际游戏项目中，特效师需要理解流体纹理的原理，并能在Houdini FLIP/Pyro、Niagara Fluid、Compute Shader中熟练运用。
