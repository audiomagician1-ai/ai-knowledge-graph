...
胶片颗粒是后处理特效领域的基础知识点。胶片噪点与扫描线等复古效果

### 关键要点

- **定义**: 胶片颗粒——胶片噪点与扫描线等复古效果
- **难度级别**: 基础（难度2/5）
- **应用场景**: 胶片颗粒在游戏特效制作中是入门必备知识
- **引擎支持**: UE5/Unity通用后处理管线

### 详细说明

胶片颗粒涉及多个方面的专业知识。在实际游戏项目中，特效师需要理解胶片颗粒的原理，并能在Post Process Volume、Custom Render Pass、Render Target中熟练运用。
