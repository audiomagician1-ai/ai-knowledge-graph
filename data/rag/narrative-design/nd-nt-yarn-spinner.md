...
Yarn Spinner是提升叙事团队生产力的重要环节。Unity生态的对话脚本工具Yarn Spinner
...
- **进阶阶段**: 建议结合实际游戏案例分析，理解Yarn Spinner的设计意图
- 推荐参考游戏与GDC演讲来深入理解概念的应用
- 尝试用简单工具（如Twine）实践相关设计

## 关键术语

- **Yarn Spinner**: Unity生态的对话脚本工具Yarn Spinner

---
*叙事设计 > 叙事工具 > Yarn Spinner*
